...
import MarketingApp from "../../Landing/MarketingApp";

const DynamicList = ({header, description, imageList, totalPages, currentPage, imagesPerPage }) => {
  return (
    <div>

      <Navigation />
      
      <div className="hero bg-tree">
        <div className="hero-content text-center">
          <div className="max-w-md">
            <h1 className="text-3xl capitalize md:text-6xl font-bold Monaco text-white">
              {header}{" "}
