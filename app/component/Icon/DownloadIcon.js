...
import { generatePDF } from "@/app/lib/invoice-helpers";

const DownloadIcon = ({businessInfo, customerInfo}) => {
  return (
  
      <svg
        className="w-8 cursor-pointer hover:text-slate-500 "
        viewBox="0 0 24 24"
        fill="none"
        onClick={(e) => generatePDF(businessInfo, customerInfo)}
