...
const CardPricing = ({
    ...
    return (
        ...
        <div className="relative items-center w-full mx-auto md:px-12 lg:px-16 max-w-6xl p-2"><div>

      <h2 className='text-center text-md mt-5 mb-2 font-bold text-black  md:text-3xl'> Pricing</h2>
            {/***********************  Basic Pricing ****************************/}
          ...
          {constants.CARD_PRICING_DES.map((val, index) => 
                ...
                <div className="flex-1 ">
                    <h3 className="text-xl font-semibold  ">{val?.header}
                         {/* {val.savePricing === true && <span className='link link-accent text-sm'>save $2.00</span> } */}
                         </h3>
                    <div className="flex items-baseline mt-4  gap-2">
                        <del className="text-xl md:text-2xl">{val?.discountPricing}</del>
                ...
                <div className="mt-6 rounded-lg">
                    <Link type="highlight" href={`/user/signup?accountType=${val.card_pricing}`}
